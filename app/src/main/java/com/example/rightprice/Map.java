...
public class Map extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (mLocationPermissionsGranted) {
            ...
            Vehicle bird = new Vehicle("bird","id",50,32.8797,-117.2362,"$1.00 Start $0.15/Minute");
            Vehicle lime = new Vehicle("lime","id",69,32.8785,-117.2397,"$1.50 Start $0.20/Minute");
            Vehicle spin = new Vehicle("spin","id",100,32.8851,-117.2392,"$2.00 Start $0.10/Minute");
            Vehicle spin2 = new Vehicle("spin","id",100,32.8801,-117.2340,"$2.00 Start $0.10/Minute");
            spin2.setType("scooter");
            bird.setType("scooter");
            lime.setType("scooter");
            spin.setType("bike");
            vehicleArrayList.add(bird);
            vehicleArrayList.add(lime);
            vehicleArrayList.add(spin);
            vehicleArrayList.add(spin2);

            loadVehiclePins(mMap,vehicleArrayList,markerArrayList);
                ...
                public boolean onMarkerClick(Marker marker) {
                    if(marker.getTag() != null ){
                        ...
                        if(vehicle.getBattery()==-1){
                            batteryValue.setText("None");
                        } else {
                            batteryValue.setText(Integer.toString(vehicle.getBattery())+"%");
                        }
                        priceLabel.setText(vehicle.getPrice());
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        priceLabel = findViewById(R.id.popup_price_label);
